...
Version  : 6.7.3
Release  : 19
URL      : https://download.qt.io/official_releases/qt/6.7/6.7.3/submodules/qtnetworkauth-everywhere-src-6.7.3.zip
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.3/submodules/qtnetworkauth-everywhere-src-6.7.3.zip
...
%prep
%setup -q -n qtnetworkauth-everywhere-src-6.7.3
cd %{_builddir}/qtnetworkauth-everywhere-src-6.7.3
pushd ..
cp -a qtnetworkauth-everywhere-src-6.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727819051
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtNetworkAuth/6.7.3/QtNetworkAuth/private/qabstractoauth2_p.h
/usr/include/QtNetworkAuth/6.7.3/QtNetworkAuth/private/qabstractoauth_p.h
/usr/include/QtNetworkAuth/6.7.3/QtNetworkAuth/private/qabstractoauthreplyhandler_p.h
/usr/include/QtNetworkAuth/6.7.3/QtNetworkAuth/private/qoauth1_p.h
/usr/include/QtNetworkAuth/6.7.3/QtNetworkAuth/private/qoauth1signature_p.h
/usr/include/QtNetworkAuth/6.7.3/QtNetworkAuth/private/qoauth2authorizationcodeflow_p.h
/usr/include/QtNetworkAuth/6.7.3/QtNetworkAuth/private/qoauthhttpserverreplyhandler_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6NetworkAuth.so.6.7.3
/usr/lib64/libQt6NetworkAuth.so.6
/usr/lib64/libQt6NetworkAuth.so.6.7.3
