...
Version  : 6.6.3
Release  : 15
URL      : https://download.qt.io/official_releases/qt/6.6/6.6.3/submodules/qtnetworkauth-everywhere-src-6.6.3.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.3/submodules/qtnetworkauth-everywhere-src-6.6.3.tar.xz
...
%prep
%setup -q -n qtnetworkauth-everywhere-src-6.6.3
cd %{_builddir}/qtnetworkauth-everywhere-src-6.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711492786
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtNetworkAuth/6.6.3/QtNetworkAuth/private/qabstractoauth2_p.h
/usr/include/QtNetworkAuth/6.6.3/QtNetworkAuth/private/qabstractoauth_p.h
/usr/include/QtNetworkAuth/6.6.3/QtNetworkAuth/private/qabstractoauthreplyhandler_p.h
/usr/include/QtNetworkAuth/6.6.3/QtNetworkAuth/private/qoauth1_p.h
/usr/include/QtNetworkAuth/6.6.3/QtNetworkAuth/private/qoauth1signature_p.h
/usr/include/QtNetworkAuth/6.6.3/QtNetworkAuth/private/qoauth2authorizationcodeflow_p.h
/usr/include/QtNetworkAuth/6.6.3/QtNetworkAuth/private/qoauthhttpserverreplyhandler_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6NetworkAuth.so.6.6.3
/usr/lib64/libQt6NetworkAuth.so.6
/usr/lib64/libQt6NetworkAuth.so.6.6.3
